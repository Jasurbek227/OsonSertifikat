...
<section class="page-section admin-page">
    ...
    <form method="POST" class="admin-form">
        ...
        <div class="admin-form-section">
            ...
            <div id="selectedImageList" class="admin-selected-image-list">

                <?php if (count($images) > 0): ?>

                    <?php foreach ($images as $image): ?>

                        <div class="admin-selected-image">
                        ...
                        <input type="hidden" name="image_paths[]" value="<?php
                        echo htmlspecialchars(
                            $image['file_path'],
                            ENT_QUOTES,
                            'UTF-8'
            ...
            <button type="button" class="admin-secondary-button" id="openImagePicker">
